  ...
  return (
    <div>
      <h1 className="text-center text-3xl font-bold pt-10">
        Inspiring Testimonials from Our Community
      </h1>
      <p className="text-center text-xl py-5 max-w-3xl mx-auto">
        Our clients rave about their fitness journey with us, citing remarkable
        transformations and renewed vitality. Join our community and start your
        own success story today!
      </p>
